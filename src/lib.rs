...
#[derive(Debug)]
pub struct SandAdapterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SandAdapterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SandAdapter processing");
    
    let mut processor = SandAdapterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SandAdapterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SandAdapterProcessor::new(false);
